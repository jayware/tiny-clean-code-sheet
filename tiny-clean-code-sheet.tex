...
\definecolor{subsection}{rgb}{0.7,0.7,0.7}
\definecolor{pagecolor}{rgb}{0.4,0.4,0.4}
\definecolor{textcolor}{rgb}{0.9,0.9,0.9}
\definecolor{shadowColor}{rgb}{0.3,0.3,0.3}

\titlespacing*{\subsection}{0pt}{0mm}{0mm}
\titleformat{\subsection}{\color{subsection}\fontfamily{phv}\fontsize{13}{17}\bfseries}{\thesubsection}{1em}{}
...
\begin{document}
	...
	\newpage
	\degreesection{Blauer Grad}{blueDegree}
	\begin{minipage}[t]{.5\textwidth}
		\subsection*{Prinzipien}
